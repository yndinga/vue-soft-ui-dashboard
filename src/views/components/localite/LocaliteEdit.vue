<template>
    <div class="card mb-4 p-4">
      <div class="card-header pb-0">
        <h6>Formulaire d'insertions des produits</h6>
      </div>
...
import useStock from "@/composables/stocks";
import { onMounted } from "vue";
const { errors, stock, getStock, updateStock, actions, getActions, localisations, getLocalisations, produits, getProduits } = useStocks()
...
onMounted(getStock(props.id))
const saveStock = async () => {
    await updateStock(props.id)
}
  </script>
